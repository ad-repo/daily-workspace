...
def verify_database():
    ...
    if orphaned_entries > 0:
        ...
        print(f"  ✓ All note_entries have valid daily_note_id references")
    ...
    if orphaned_entry_labels > 0:
        ...
        print(f"  ✓ All entry_labels have valid entry_id references")
    ...
    if orphaned_label_refs > 0:
        ...
        print(f"  ✓ All entry_labels have valid label_id references")
